...
chars(["Darth Vader","Anakin", "Anakin Skywalker", "Vader"],"Empire","Sith")
chars(["Biggs", "Red Three"],"Rebel Alliance", "None")
...
chars(["Luke Skywalker", "Luke", "Red Five"],"Rebel Alliance","Jedi")
